					...
					<!-- start: page -->
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Charity table</h2>
							</header>
								...
								<table class="table table-bordered table-striped mb-none" id="datatable-editable">
									<thead>
										<tr>
											...
											<th><p style="margin: 0 20px;">Phone_Number</p></th>
											<th><p style="margin: 0 100px;">Description</p></th>
											<th><p style="margin: 0 40px;">Address</p></th>
											<th><p style="margin: 0 20px;">Longitude</p></th>
											<th><p style="margin: 0 20px;">Lagtitude</p></th>
											<th><p style="margin: 0 30px;">Facebook_link</p></th>
											<th><p style="margin: 0 30px;">Photo</p></th>
											<th><p style="margin: 0 0;">Actions</p></th>
										</tr>
									</thead>
									<tbody>
										<tr class="gradeX">
											...
											<td>Win 95+</td>
											<td>:(1)Education support program for informal education to orphans and needy children at basic education level.</br>
(2)Relief and rehabilitation for diasater and victims program.</br>
(3)Women and Children protection program.</td>
											<td>Internet
												Explorer 4.0
											</td>
											<td>Win 95+</td>
					...
					<div class="nano-content">
						...
						<div class="sidebar-right-wrapper">
							...
							<div class="sidebar-widget widget-calendar">
								...
								<ul>
									<li>
										<time datetime="2014-04-19T00:00+00:00"></time>
...
<!-- Vendor -->
		...
		<!-- Examples -->
		<script src="vendor/examples.datatables.editable.js"></script>
	</body>
</html>