...
<div class="row justify-content-around">
	...
	<div class="row"  style="margin-top:4em;margin-left: 15%;">
			<div class="malorm-bottom" style="box-shadow: 0 2px 5px 0 rgba(0, 0, 0, 0.2), 0 4px 10px 0 rgba(0, 0, 0, 0.19);width: 80%">
				...
				<p style="margin-left: 0% !important;line-height: 40px !important;">
				...
				<spam style="color:#FC8213">Address  :  </spam> lkjoijijk jiojoij joijoi joijoij ijoij lkjoijijk jiojoij joijoi joijoij ijoij</br>
